...
describe('module Evenements dans le gabarit public', () => {
  ...
  it("laisse la page d'inscription atteinte par QR code, module actif ou non", async () => {
    // Le QR est imprime et remis en main propre. Le back fait autorite sur le
    // jeton et rend 404 quand le module est inactif ; la page l'annonce en
    // parlant du lien, ce que « Rubrique en preparation » ne ferait pas.
