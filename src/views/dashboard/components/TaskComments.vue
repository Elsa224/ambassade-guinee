                ...
                <div v-if="comment.replies && comment.replies.length > 0" class="mt-4 space-y-3">
                  ...
                  >
                    <div class="flex gap-3">
                      <div class="flex-shrink-0">
                        <div
                          class="w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white text-xs font-semibold"
                        >
...
const comments = ref([
  {
    ...
    content:
      'La mise à jour de la liste des API a été complétée avec succès. Tous les endpoints sont maintenant fonctionnels.',
    likes: 3,
    isLiked: false,
    showReply: false,
    replyText: '',
  ...
  },
  {
    ...
    content:
      "N'oubliez pas de tester tous les cas d'utilisation avant le déploiement en production.",
    likes: 1,
    isLiked: true,
    showReply: false,
    replyText: '',
...
const editComment = (commentId) => {
  router.push({
    name: 'EditComment',
    params: { id: router.currentRoute.value.params.id, commentId },
  })
}
