  ...
  <div class="dashboard-container">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <router-link to="/admin/articles" class="text-sm text-primary hover:underline"
            >Voir tous →</router-link
          >
        </div>
        <div class="space-y-3">
          <div
            v-for="article in derniersArticles"
            :key="article.id"
            class="flex gap-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer"
          >
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <router-link to="/admin/commentaires" class="text-sm text-primary hover:underline"
            >Voir tous →</router-link
          >
        </div>
        <div class="space-y-3">
          <div
            ...
            :key="msg.id"
            class="flex gap-3 p-2 hover:bg-gray-50 rounded-lg"
          >
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <router-link
          to="/admin/parametres"
          class="p-4 text-center hover:bg-gray-50 rounded-lg transition-colors block"
        >
