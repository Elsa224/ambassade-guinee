    ...
    <div>
      <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold text-gray-800">
          ...
          <span class="text-sm font-normal text-gray-500 ml-2"
            >({{ photosFiltrees.length }} photos)</span
          >
        </h3>
        <div class="flex gap-2">
          <button
          ...
          <div class="relative h-56 overflow-hidden">
            ...
            >
              <button
                ...
                class="bg-white text-primary p-2 rounded-full hover:scale-110 transition-transform"
              >
                <i class="bx bx-show"></i>
              </button>
              <button
                @click="editPhoto(photo)"
                class="bg-white text-secondary p-2 rounded-full hover:scale-110 transition-transform"
              >
                <i class="bx bx-edit-alt"></i>
              </button>
              <button
                @click="deletePhoto(photo.id)"
                class="bg-white text-red-600 p-2 rounded-full hover:scale-110 transition-transform"
              >
                <i class="bx bx-trash"></i>
              </button>
            </div>
      ...
      <div class="mt-6 flex items-center justify-between">
        <div class="text-sm text-gray-500">
          ...
          {{ Math.min(pageCourante * itemsParPage, photosFiltrees.length) }} sur
          {{ photosFiltrees.length }} photos
        </div>
        <div class="flex gap-2">
          <button
            @click="pageCourante--"
        ...
        <div class="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form @submit.prevent="savePhoto" class="p-4">
              ...
              <div v-if="uploadedFiles.length > 0" class="grid grid-cols-4 gap-2 mt-4">
                ...
                >
                  ...
                  <button
                    ...
                    class="absolute top-1 right-1 bg-black/60 text-white rounded-full w-5 h-5 flex items-center justify-center hover:bg-red-600"
                  >
            ...
            <div class="mb-4">
              ...
              >
              <input
                v-model="formPhoto.tags"
                type="text"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary"
                placeholder="ex: événement, diplomatie, conférence"
              />
            </div>
        ...
        <div class="bg-white rounded-lg w-full max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <form @submit.prevent="saveAlbum" class="p-4">
            <div class="mb-4">
              ...
              <input
                v-model="formAlbum.nom"
                type="text"
                required
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary"
                placeholder="Ex: Visite officielle 2024"
              />
            </div>
            <div class="mb-4">
              <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
          ...
          <div class="p-4">
            ...
            <div v-if="viewPhotoData.tags" class="pt-4 border-t">
              ...
              <div class="flex gap-2 mt-1 flex-wrap">
                <span
                  v-for="tag in viewPhotoData.tags.split(',')"
                  :key="tag"
...
const modalTitle = computed(() =>
  modalMode.value === 'add' ? 'Ajouter des photos' : 'Modifier la photo',
)
const modalButtonText = computed(() => (modalMode.value === 'add' ? 'Ajouter' : 'Enregistrer'))
const albumModalTitle = computed(() =>
  albumModalMode.value === 'add' ? 'Nouvel album' : "Modifier l'album",
)
...
const saveAlbum = () => {
  if (albumModalMode.value === 'add') {
    const newAlbum = {
      ...
      couverture:
        formAlbum.value.coverPreview || 'https://placehold.co/200x150/006633/white?text=Album',
      date: new Date().toISOString().split('T')[0],
      nbPhotos: 0,
    }
...
const loadData = () => {
  albums.value = [
    {
      id: 1,
      nom: 'Visites officielles',
      description: 'Photos des visites officielles',
      couverture: visitesOfficiellesCover,
      date: '2024-01-15',
      nbPhotos: 4,
    },
    {
      id: 2,
      nom: 'Cérémonies',
      description: "Cérémonies à l'ambassade",
      couverture: ceremoniesCover,
      date: '2024-01-10',
      nbPhotos: 3,
    },
    {
      id: 3,
      nom: 'Conférences',
      description: 'Conférences diplomatiques',
      couverture: conferencesCover,
      date: '2024-01-05',
      nbPhotos: 3,
    },
  ]
  ...
  photos.value = [
    {
      id: 1,
      titre: "Rencontre avec l'ambassadeur",
      description: 'Photo officielle de la rencontre',
      albumId: 1,
      albumNom: 'Visites officielles',
      tags: 'diplomatie,ambassadeur',
      url: rencontreOfficielleImage,
      date: '2024-01-15',
      vues: 245,
      size: 512000,
    },
    {
      id: 2,
      titre: "Signature d'accord",
      description: 'Cérémonie de signature',
      albumId: 1,
      albumNom: 'Visites officielles',
      tags: 'accord,coopération',
      url: signatureAccordImage,
      date: '2024-01-14',
      vues: 189,
      size: 478000,
    },
    {
      id: 3,
      titre: 'Cérémonie de la fête nationale',
      description: "Célébration à l'ambassade",
      albumId: 2,
      albumNom: 'Cérémonies',
      tags: 'fête nationale',
      url: feteNationalePhoto,
      date: '2024-01-12',
      vues: 356,
      size: 623000,
    },
    {
      id: 4,
      titre: 'Conférence de presse',
      description: 'Point de presse',
      albumId: 3,
      albumNom: 'Conférences',
      tags: 'conférence,presse',
      url: conferencePresseImage,
      date: '2024-01-10',
      vues: 178,
      size: 345000,
    },
    {
      id: 5,
      titre: 'Remise des lettres',
      description: 'Remise des lettres de créance',
      albumId: 1,
      albumNom: 'Visites officielles',
      tags: 'diplomatie',
      url: remiseLettresImage,
      date: '2024-01-08',
      vues: 98,
      size: 512000,
    },
    {
      id: 6,
      titre: 'Gala diplomatique',
      description: 'Soirée de gala',
      albumId: 2,
      albumNom: 'Cérémonies',
      tags: 'gala,soirée',
      url: galaDiplomatiqueImage,
      date: '2024-01-05',
      vues: 234,
      size: 789000,
    },
    {
      id: 7,
      titre: 'Séminaire économique',
      description: "Séminaire sur l'économie",
      albumId: 3,
      albumNom: 'Conférences',
      tags: 'économie',
      url: seminaireEconomiqueImage,
      date: '2024-01-03',
      vues: 145,
      size: 432000,
    },
