        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2">
            <div class="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Les Bahamas sont un pays des Caraïbes relevant de la <span class="font-bold text-accent">monarchie parlementaire sous le Commonwealth britannique</span>, avec un système de gouvernement démocratique.
              </p>
        ...
        <div class="space-y-6">
          <div class="bg-gray-50 p-6 rounded-xl">
            ...
            <p class="text-gray-700 text-lg">
              La coopération bilatérale entre la République de Guinée et le Commonwealth des Bahamas reste <span class="font-bold text-accent">limitée</span> dans les instances de l'<span class="font-bold">Organisation des Nations Unies</span>.
            </p>
          </div>

          <div class="bg-blue-50 border-l-4 border-primary-light p-4 rounded-r-xl">
            <div class="flex items-start gap-3">
              <svg class="w-6 h-6 text-primary-light flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              </svg>
              <div>
